...
class UserListPage(QtWidgets.QWidget):
    ...
    def __init__(self, core=None, parent=None):
        ...
        self._info_templates = {
            "local": t_local["local_label"],
            "broadcast": t_local["broadcast_label"],
            "mask": t_local["mask_label"],
            "nodes": t_local["nodes_label"],
        }
    ...
    def _build(self) -> None:
        ...
        self.search_edit.setPlaceholderText(t_local["search_ph"])
        self.search_edit.textChanged.connect(self._apply_filter)
        self.discover_btn = NavigationButton(t_local["discover"])
        self.discover_btn.setToolTip(t_local['discover_tip'])
        ...
        self.btn_discover_ip = NavigationButton(t_local["discover"])
