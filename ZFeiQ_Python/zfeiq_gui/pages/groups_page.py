...
class GroupsPage(QtWidgets.QWidget):
    ...
    def _build(self) -> None:
        ...
        self.member_filter.setPlaceholderText(t_local["group_search_ph"])
        ...
        self.btn_new_group = _mk_nav_btn(t_local["group_new"])
        self.btn_rename = _mk_nav_btn(t_local["group_rename"])
        ...
        self.member_edit.setPlaceholderText(t_local["member_ph"])
    ...
    def _prompt_rename(self):
        ...
        new_name, ok = QtWidgets.QInputDialog.getText(
            self,
            t_local["group_rename"],
            t_local["group_new_name"],
            text=old,
        )
