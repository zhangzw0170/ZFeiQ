...
class FilesPage(QtWidgets.QWidget):
    ...
    def _build(self) -> None:
        ...
        btn_pick = QtWidgets.QPushButton(t_local["pickdir"])
        btn_apply = QtWidgets.QPushButton(t_local["setdefault"])
        ...
        self.btn_accept = QtWidgets.QPushButton(t_local["accept"])
        self.btn_cancel = QtWidgets.QPushButton(t_local["cancel"])
