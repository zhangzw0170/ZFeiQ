# 功能更新日志（超详细，至 Alpha 3.6）

以下为 ZFeiQ 自 CLI 初版到 GUI Alpha 3.6 的关键演进记录，时间采用 24 小时制。
...
- Alpha 3.0 — 3.4：GUI 初版到文件块/气泡/组页优化阶段。
- **Alpha 3.5**：GUI 导航与页面结构重组。
- **Alpha 3.6（当前）**：下载目录默认行为、用户/组列表双击跳转聊天、语言与状态展示完善、RK3566 嵌入式体验优化。
